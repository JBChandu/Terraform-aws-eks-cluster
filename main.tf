...
# Add cluster tags to subnets after cluster creation
resource "aws_ec2_tag" "eks_subnet_1_cluster_tag" {
  resource_id = aws_subnet.eks_subnet_1.id
...
resource "aws_ec2_tag" "eks_subnet_2_cluster_tag" {
  resource_id = aws_subnet.eks_subnet_2.id
  key         = "kubernetes.io/cluster/${aws_eks_cluster.eks_cluster.name}"
  value       = "shared"
